...
if __name__ == '__main__':
    ali = AliPay(app_notify_url='http://127.0.0.1',return_url='http://127.0.0.1',appid='2016091200491710',app_private_key_path='app_private_key',alipay_public_key_path='app_public_key')
